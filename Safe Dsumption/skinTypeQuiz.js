function checkAnswer(){
    ...
    // testScore.textContent = `Your test score is ${points}.`
    if(points >= 0 && points <= 6){
        skinType.innerHTML = "You have skin type I (1)";
    //    skinType.textContent = `You have skin type I.`
    }else if(points >= 7 && points <= 12){
        skinType.innerHTML = "You have skin type II (2)";
    }else if(points >= 13 && points <= 18){
        skinType.innerHTML = "You have skin type III (3)";
    }else if(points >= 19 && points <= 24){
        skinType.innerHTML = "You have skin type IV (4)";
    }else if(points >= 25 && points <= 30){
        skinType.innerHTML = "You have skin type V (5)";
    }else if(points >= 31){
        skinType.innerHTML = "You have skin type VI (6)";
    }
